...
"[project]/app/api/accreditation/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
/** Generates a human-readable, unambiguous voting code */ function generateVotingCode() {
...
async function POST(req) {
    try {
        ...
        const registeredVoter = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].registeredVoter.findUnique({
            where: {
                nipr: trimmedNipr
            }
        });
        ...
        // ── Verify PIN ────────────────────────────────────────────────────────
        const pinValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$bcryptjs$40$3$2e$0$2e$3$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compare"])(pin, registeredVoter.pin);
        if (!pinValid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        let election;
        if (electionId) {
            election = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].election.findUnique({
                where: {
                    id: electionId
                }
            });
        } else {
            election = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].election.findFirst({
                where: {
                    status: "ACTIVE"
                },
                orderBy: {
        ...
        const [existingEmail, existingNipr] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].accreditedVoter.findUnique({
                where: {
                    electionId_email: {
        ...
        let attempts = 0;
        while(await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].accreditedVoter.findUnique({
            where: {
                code
            }
        })){
        ...
        // ── Persist ───────────────────────────────────────────────────────────
        const voter = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].accreditedVoter.create({
            data: {
                electionId: election.id,
...
async function GET(req) {
    try {
        ...
        const voter = code ? await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].accreditedVoter.findUnique({
            where: {
                code
            }
        }) : await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].accreditedVoter.findFirst({
            where: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9268608e._.js.map