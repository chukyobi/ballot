...
"[project]/app/api/vote/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        // ── Validate voter ────────────────────────────────────────────────────────
        const voter = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].accreditedVoter.findUnique({
            where: {
                code
            }
        });
        ...
        const position = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].position.findUnique({
            where: {
                id: positionId
            },
            include: {
        ...
        const existingVote = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].vote.findUnique({
            where: {
                voterId_positionId: {
                    voterId: voter.id,
                    positionId
        ...
        const [vote] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$transaction([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].vote.create({
                data: {
                    voterId: voter.id,
                    positionId,
                    candidateId
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].voteActivity.create({
                data: {
        ...
        const totalPositions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].position.count({
            where: {
                electionId: voter.electionId
            }
        });
        const totalVotesForVoter = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].vote.count({
            where: {
                voterId: voter.id,
                position: {
                    electionId: voter.electionId
        ...
        if (totalVotesForVoter >= totalPositions) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].accreditedVoter.update({
                where: {
                    id: voter.id
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9b1c1545._.js.map