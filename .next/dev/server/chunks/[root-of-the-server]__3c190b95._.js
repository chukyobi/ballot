...
async function readSettings() {
    ...
    const row = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].settings.upsert({
        where: {
            id: SETTINGS_ID
        },
        create: {
    ...
    if (registrationOpen && row.registrationEndTime && row.registrationEndTime.getTime() <= Date.now()) {
        registrationOpen = false;
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].settings.update({
            where: {
                id: SETTINGS_ID
            },
            data: {
...
async function POST(req) {
    try {
        ...
        if (body.registrationStartTime !== undefined) {
            data.registrationStartTime = body.registrationStartTime ? new Date(body.registrationStartTime) : null;
        }
        if (body.registrationEndTime !== undefined) {
            data.registrationEndTime = body.registrationEndTime ? new Date(body.registrationEndTime) : null;
        }
        const row = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].settings.upsert({
            where: {
                id: SETTINGS_ID
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(response);
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3c190b95._.js.map